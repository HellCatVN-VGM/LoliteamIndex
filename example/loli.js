    ...
    .controller('console', ['$scope', '$ga', 'commandBroker', '$rootScope', function ($scope, $ga, commandBroker, $rootScope) {
        ...
        setTimeout(function () {
            $scope.$broadcast('terminal-output', {
                output: true,
                text: ["  ,       _______   ,       ________    ________ _______  _______  _______ ",
                    ...
                    '(_______/(_______)(______//________/      |_/   (_______/|/     (||/     (|',
                    '#Chào mừng đến với LoLi Sec Team',
                    '#Cùng trải nghiệm giao diện web command mode đậm chất hacker nhé.',
                    '',
                    "Vui lòng gõ 'help' để xem danh sách các lệnh.", 'Dùng phím mũi tên lên xuống để xem lại các lệnh vừa dùng.'
                ],
                breakLine: true
            });
            $scope.$apply();
